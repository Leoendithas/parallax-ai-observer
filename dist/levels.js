...
// These are samples of the proposed chapters, not placeholders for unbuilt rooms.
export const PROTOTYPE_IDS = [7,13,19];
LEVELS.push(
 {
  id:7,prototype:true,chapter:'Sightline seals',name:'A line<br>of sight.',menu:'A line of sight',
  ...
  hint:'Walk the amber path to the white stone marked with a circle. Enter first person. Look north and slightly up until the two arcs form a ring at the center of your view, then bind the seal. The blue path will stay open.'
 },
 {
  id:13,prototype:true,chapter:'Rotating islands',name:'A world<br>that turns.',menu:'A world that turns',
 ...
 {
  id:19,prototype:true,chapter:'Combined mastery',name:'The shape<br>of an answer.',menu:'The shape of an answer',
